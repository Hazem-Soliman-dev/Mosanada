...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Payment recorded', type: payment_dto_1.PaymentResponseDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of payments', type: [payment_dto_1.PaymentResponseDto] }),
    __param(0, (0, tenant_decorator_1.TenantId)()),
    __metadata("design:type", Function),
